              ...
              <?php if ($this->session->userdata('ses_identitas') == '1'): ?>
                <div class="profile_pic">
                  <?php foreach ($identitas->result() as $iden): ?>                   
                      <img src="<?php echo base_url() ?>assets/upload/images/<?=$iden->image?>" alt="..." class="img-circle profile_img">
                    <?php endforeach ?>
                </div>
              <?php else: ?>
                <div class="profile_pic">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">              
              <div class="menu_section">
                ...
                <ul class="nav side-menu">                                   
                  <li><a href="<?php echo base_url() ?>pelamar"><i class="fa fa-laptop"></i> Dashboard </a></li>
                  <li><a href="<?php echo base_url() ?>pelamar/profil"><i class="fa fa-child"></i> Profil </a></li>
                  <li><a href="<?php echo base_url() ?>pelamar/loker"><i class="fa fa-clipboard"></i> Lowongan Kerja </a></li>
                </ul>
              </div>
