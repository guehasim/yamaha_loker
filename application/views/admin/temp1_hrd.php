                  ...
                  <li>
                    ...
                    <?php foreach ($status->result() as $s): ?>
                       <?php if ($s->status_recruitment == 1): ?>
                         <li><a href="<?php echo base_url() ?>admin/status_tutup"><i class="fa fa-laptop"></i> Rekruitmen<span class="badge badge-success pull-right">DIBUKA</span></a></li>
                       <?php else: ?>
                         <li><a href="<?php echo base_url() ?>admin/status_buka"><i class="fa fa-laptop"></i> Rekruitmen<span class="badge badge-danger pull-right">DITUTUP</span></a></li>
                       <?php endif ?>
                     <?php endforeach ?> 
