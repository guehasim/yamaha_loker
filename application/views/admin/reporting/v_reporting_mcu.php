          ...
          <div class="">
            ...
            <div class="row">              
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <a href="<?php echo base_url() ?>admin/riwayat_status_mcu"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-book"></i> Riwayat Gagal</button></a>
                  ...
                  <div class="x_content">
                      <div class="row">
                        <form method="post" action="<?php echo base_url(); ?>admin/aksi_mcu">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tahap-info-<?php echo $pel->ID_PelamarJoin;?>"><i class="fa fa-thumbs-up"></i> Lolos Interview Lanjutan </button>                            
                            ...
                            <div class="modal-content edit-dialog-modal">
                              <form class="form-validate form-horizontal " id="register_form" action="<?php echo base_url(); ?>admin/pelamar_naik_ketahap" method="post">    
                                ...
                                <div class="modal-header">
                                  <h4 class="modal-title" id="myModalLabel">Lolos Tahap Interview Lanjutan</h4>                                  
                                ...
                                <div class="modal-body">
                                  ...
                                  Apakah anda benar mau menaikan status Pelamar "<?php echo $pel->nama_ktp;?>" ini lolos tahap Interview Lanjutan?
                                </div>
                                <div class="modal-footer">
                                  <button type="submit" class="btn btn-primary"><i class="fa fa-thumbs-up"></i> Lolos Interview Lanjutan </button>
                            ...
                            <div class="modal-content edit-dialog-modal">
                              <form class="form-validate form-horizontal " id="register_form" action="<?php echo base_url(); ?>admin/pelamar_gagal" method="post">    
                                ...
                                <div class="modal-body">
                                  ...
                                  Apakah anda benar "<?php echo $pel->nama_ktp;?>" gagal ke Tahap Interview Lanjutan?
                                </div>
                                <div class="modal-footer">
