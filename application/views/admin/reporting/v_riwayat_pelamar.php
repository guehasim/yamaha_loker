          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h2>Riwayat Pelamar Gagal Tahap Administrasi</h2>
              </div>
            ...
            <div class="row">              
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <a href="<?php echo base_url() ?>admin/status_pelamar"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-mail-reply"></i> KEMBALI</button></a>
                  ...
                  <div class="x_content">
                      <div class="row">
                        <form method="post" action="<?php echo base_url(); ?>admin/riwayat_aksi_pelamar">
