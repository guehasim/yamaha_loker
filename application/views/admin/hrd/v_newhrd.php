		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>admin/tambah_hrd">
							...
							<div class="item form-group">
								<div class="col-md-6 col-sm-6 offset-md-3">
									...
									<a href="<?php echo base_url() ?>admin/data_hrd"><button class="btn btn-primary" type="button">Kembali</button></a>
								</div>
							</div>
