  ...
  <div class="">
    ...
    <div class="row">              
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <a href="<?php echo base_url() ?>admin/new_hrd"><button type="button" class="btn btn-success btn-sm">HRD Baru</button></a>
          ...
          <div class="x_content">
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php $no = 1; foreach ($hrd->result() as $ad): ?>
                <tr>
                  <td><?php echo $no++;?></td>
                  <td><?php echo $ad->User;?></td>
                  <td>
                    <a href="<?php echo base_url() ?>admin/get_hrd?us=<?php echo $ad->ID_User; ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                ...
                <div class="modal fade" id="hapus-info-<?php echo $ad->ID_User;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content edit-dialog-modal">
                      <form class="form-validate form-horizontal " id="register_form" action="<?php echo base_url(); ?>admin/hapus_hrd" method="post">    
                        <?php
