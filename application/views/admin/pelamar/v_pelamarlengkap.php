          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h2>List Akun Pelamar Data Lengkap</h2>
              </div>
                      ...
                      <tbody>
                        <?php $no = 1; foreach ($pelamar->result() as $lok): ?>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url() ?>admin/get_pelamarsudah?us=<?php echo $lok->ID_Pelamar;?>"> <button type="button" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> Edit</button></a> 
