								...
								<div class="x_content">
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>admin/update_pelamar">
										...
										<div class="item form-group form-check">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="pass" id="first-name" required="required" class="form-control"  value="<?php echo base64_decode($iden->pass);?>">
											</div>
										</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<a href="<?php echo base_url() ?>admin/data_pelamar_belum"><button class="btn btn-primary" type="button">Kembali</button></a>
											</div>
										</div>
